...
lbl2=tk.Label(window, text= "Enter a Task...", font="normal 15 bold",fg="black",bg="light pink").place(x=100 ,y = 60)
...
lbl=tk.Label(window, text= "Made By Prerna Anand", font="normal 11 bold",fg="black",bg="light pink").place(x=90,y=500)
