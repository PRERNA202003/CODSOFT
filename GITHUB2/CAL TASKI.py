...
def operation():
    ...
    l1 = tk.Label(window, text="Enter the 1st number :", font="normal 11 bold", fg="blue", bg="LIGHT pink")
    l1.pack(side=tk.TOP, pady=10)
    
    n1 = tk.Entry(window)
    n1.pack()
    
    l2 = tk.Label(window, text="Enter the 2nd number :", font="normal 11 bold", fg="blue", bg="LIGHT pink")
    l2.pack(side=tk.TOP, pady=10)
    
    n2 = tk.Entry(window)
    n2.pack()
    
    l3 = tk.Label(window, text="1 Addition", font="normal 11 bold", fg="black", bg="LIGHT pink")
    l3.pack(side=tk.TOP, pady=5)
    
    l4 = tk.Label(window, text="2 Subtraction", font="normal 11 bold", fg="black", bg="LIGHT pink")
    l4.pack(side=tk.TOP, pady=5)
    
    l5 = tk.Label(window, text="3 Multiplication", font="normal 11 bold", fg="black", bg="LIGHT pink")
    l5.pack(side=tk.TOP, pady=5)
    
    l6 = tk.Label(window, text="4 Division", font="normal 11 bold", fg="black", bg="LIGHT pink")
    l6.pack(side=tk.TOP, pady=5)

    l7 = tk.Label(window, text=": Enter the operation number :", font="normal 13 bold", fg="red", bg="LIGHT pink")
...
la = tk.Label(text="CALCULATOR", font="normal 20 bold", fg="blue", bg="LIGHT pink")
...
laa = tk.Label(text="Made By Prerna Anand", font="normal 15 bold", fg="BLACK", bg="LIGHT pink")
