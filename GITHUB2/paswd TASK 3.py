...
password_label = tk.Label(root, text="Password Generator", font=("Arial", 16, "bold italic"), bg="light pink")
password_label.pack()

user_label = tk.Label(root, text="Enter password length:", font=("Arial", 14), bg="light pink")
user_label.place(x=110 , y=90)
...
lbl = tk.Label(root, text="Made By Prerna Anand", font=("Arial", 15, "bold italic"), bg="light pink").place(x=300 , y=300)
